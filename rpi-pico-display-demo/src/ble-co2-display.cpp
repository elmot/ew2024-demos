...
static void handle_gatt_client_event([[maybe_unused]]uint8_t packet_type,[[maybe_unused]] uint16_t channel, uint8_t *packet,[[maybe_unused]] uint16_t size) {
    UNUSED(packet_type);
    UNUSED(channel);
    UNUSED(size);
...
static void hci_event_handler(uint8_t packet_type,[[maybe_unused]] uint16_t channel, uint8_t *packet,[[maybe_unused]] uint16_t size) {
    UNUSED(size);
    UNUSED(channel);
