...
osMessageQueueId_t myDisplayQHandle;
uint8_t myDisplayQBuffer[ 8 * sizeof( uint16_t ) ];
osStaticMessageQDef_t myDisplayQControlBlock;
const osMessageQueueAttr_t myDisplayQ_attributes = {
  .name = "myDisplayQ",
  .cb_mem = &myDisplayQControlBlock,
  .cb_size = sizeof(myDisplayQControlBlock),
  .mq_mem = &myDisplayQBuffer,
  .mq_size = sizeof(myDisplayQBuffer)
};
/* USER CODE BEGIN PV */
...
/* Configure the peripherals common clocks */
  ...
  /* Create the queue(s) */
  /* creation of myDisplayQ */
  myDisplayQHandle = osMessageQueueNew (8, sizeof(uint16_t), &myDisplayQ_attributes);
